...
enum I18n {
    ...
    private static let table: [String: (uk: String, ru: String, en: String)] = [
        ...
        "settings.legal": ("Правова інформація", "Правовая информация", "Legal"),
        "settings.privacy_policy": ("Політика конфіденційності", "Политика конфиденциальности", "Privacy Policy"),
        "settings.terms_of_use": ("Умови використання", "Условия использования", "Terms of Use"),
        "settings.support_site": ("Сайт підтримки", "Сайт поддержки", "Support site"),
        "settings.support_email": ("Email підтримки", "Email поддержки", "Support email"),
